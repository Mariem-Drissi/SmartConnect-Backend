...
export class SalesController {
  ...
  @Get("orders") getOrders(
    ...
    return this.s.findAllOrders(status, cid, uid, archived === "true");
  }
  ...
  @Get("orders/:id") getOrder(@Param("id") id: string) {
    return this.s.findOneOrder(id);
  }
  @Post("orders") createOrder(
    @Body() dto: CreateOrderDto,
    @CurrentUser() u: any,
  ) {
    return this.s.createOrder(dto, u.id);
  }
  @Patch("orders/:id/archive") archive(@Param("id") id: string) {
    return this.s.archive(id);
  }
  @Patch("orders/:id/restore") restore(@Param("id") id: string) {
    return this.s.restore(id);
  }
  @Delete("orders/:id/permanent") deleteArchived(@Param("id") id: string) {
    return this.s.deleteArchived(id);
  }
  ...
  @Patch("orders/:id/sign") signOrder(
    @Param("id") id: string,
    @Body() dto: SignOrderDto,
  ) {
    return this.s.signOrder(id, dto);
  }
}
